...
class SwingGui {
	...
	private void createGameDialog() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.TRAILING)
				.addComponent(messageLabel, Alignment.CENTER)
				...
				.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup()
								.addComponent(hotSeatOption)
								.addComponent(netServerOption)
								.addComponent(netClientOption)
								.addComponent(endsField, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(team1Field, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(team2Field, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		layout.setVerticalGroup(layout.createSequentialGroup()
				...
				.addGroup(layout.createParallelGroup()
						...
						.addGroup(layout.createSequentialGroup()
								...
								.addGroup(layout.createBaselineGroup(false, false)
										.addComponent(endsLabel)
										.addComponent(endsField))
								.addGroup(layout.createBaselineGroup(false, false)
										.addComponent(team1Label)
										.addComponent(team1Field))
								.addGroup(layout.createBaselineGroup(false, false)
										.addComponent(team2Label)
										.addComponent(team2Field))
								.addGroup(layout.createBaselineGroup(false, false)
										.addComponent(hostLabel)
	...
	private void createAboutDialog() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.CENTER)
				...
				.addComponent(licenseScroll)
				.addGroup(layout.createSequentialGroup()
						.addComponent(homepageComponent)
						.addGap(0, 0, Integer.MAX_VALUE)
						.addComponent(closeButton)));
		layout.setVerticalGroup(layout.createSequentialGroup()
				.addComponent(versionLabel)
				.addComponent(copyrightLabel)
				.addComponent(licenseScroll, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGroup(layout.createBaselineGroup(false, false)
					.addComponent(homepageComponent)
					.addComponent(closeButton)));
		aboutDialog.pack();
